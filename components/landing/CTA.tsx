...
export const CTA = () => {
  return (
    <section className="py-24 relative overflow-hidden bg-dark-2">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[500px] bg-brand/10 blur-[120px] rounded-full pointer-events-none" />
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto relative">
          <div className="absolute inset-0 bg-gradient-to-r from-brand/20 to-brand-light/20 rounded-[3rem] blur-xl transform scale-95" />
          ...
          <div className="relative text-center bg-dark-3/80 backdrop-blur-xl border border-white/10 p-12 md:p-24 rounded-[3rem] shadow-2xl overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 bg-brand-light/20 rounded-full blur-[80px]" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 relative z-10">
              <Link href="/sign-up" className="w-full sm:w-auto px-10 py-4 bg-brand hover:bg-brand/90 text-white rounded-full font-bold text-lg transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(0,98,255,0.5)] flex items-center justify-center gap-2 group">
                Get Started Now
